...
/**
 * Implementación del DAO para la entidad Usuario Maneja todas las operaciones
 * de persistencia relacionadas con usuarios
 *
 * @author gatog
 */
public class UsuarioRepository implements IUsuarioRepository {
     ...
     */
    @Override
    public Usuario actualizar(Usuario usuario) throws RepositoryException {
        try {
     ...
     */
    @Override
    public Usuario eliminar(Long id) throws RepositoryException {
        try {
     ...
     */
    @Override
    public Usuario buscarPorCorreo(String correo) throws RepositoryException {
        try {
     ...
     */
    @Override
    public List<Usuario> listar(int limit, int offset) throws RepositoryException {
        try {
     ...
     */
    @Override
    public List<Usuario> buscarPorNombreCompleto(String nombre, String apellidoPaterno, int limit, int offset) throws RepositoryException {
        try {
